...
export const guidedConceptCompactPreview: TemplatePreview = {
  section: {
    section_id: "math-compact-01",
    template_id: "guided-concept-compact",
    header: {
      ...
      objective: "Solve equations by undoing operations in reverse order."
    },
    hook: {
  ...
  summary:
    "A compact algebra lesson that keeps the guided arc while moving faster than the full baseline template."
};
