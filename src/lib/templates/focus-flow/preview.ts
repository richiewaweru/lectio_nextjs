...
export const focusFlowPreview: TemplatePreview = {
  section: {
    section_id: "math-focus-01",
    template_id: "focus-flow",
    header: {
      ...
      grade_band: "primary",
      objective: "Understand a fraction as equal parts of one whole."
    },
    hook: {
    ...
    pitfall: {
      ...
      correction:
        "Halves must be equal in size because the whole has to be split into equal parts.",
      ...
      problems: [
        {
          ...
          hints: [{ level: 1, text: "The denominator is the total number of equal parts." }],
          solution: {
  ...
  summary:
    "A low-clutter fractions lesson that keeps the content in one calm column with flat practice."
};
