...
export const figureFirstPreview: TemplatePreview = {
  section: {
    section_id: "bio-figure-first-01",
    template_id: "figure-first",
    header: {
      ...
      objective: "Trace how light energy enters the chloroplast and becomes stored chemical energy."
    },
    hook: {
    ...
    pitfall: {
      ...
      correction:
        "Oxygen is a by-product. The main stored output is glucose, which keeps the captured energy.",
      ...
      problems: [
        {
          ...
          hints: [{ level: 1, text: "It is where the light-driven reactions are centered." }],
          solution: {
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: "One comes from the air and one comes from the roots." }
          ],
          solution: {
  ...
  summary:
    "A biology section that makes the chloroplast diagram the anchor for the whole lesson."
};
