...
const labPhysicsSection: SectionContent = {
  ...
  header: {
    ...
    subtitle:
      "Force, mass, and acceleration — the equation that runs the universe",
    subject: "Physics",
    grade_band: "secondary",
    objective:
      "Discover how force and mass determine acceleration by manipulating variables directly"
  },
...
update();
    ...
    fallback_diagram: {
      ...
      caption:
        "A 5 kg block with 20 N applied force and 5 N friction, producing 15 N net force and 3 m/s² acceleration.",
      alt_text:
  ...
  definition: {
    ...
    formal:
      "The acceleration of an object is equal to the net force acting upon it divided by its mass: a = F_net / m.",
  ...
  worked_example: {
    ...
    setup:
      "A 5 kg block is pushed with 20 N of force across a surface with 5 N of friction. Find the acceleration.",
    steps: [
      {
        label: "Identify all forces",
        content:
          "Applied force = 20 N (right). Friction = 5 N (left). Normal force and gravity cancel vertically."
      },
      {
      ...
      },
      {
        label: "Apply F = ma",
        content:
          "a = F_net ÷ m = 15 ÷ 5 = 3 m/s² to the right."
      }
    ],
    conclusion:
      "The block accelerates at 3 m/s² to the right — exactly what the simulation showed when you set force to 15 N and mass to 5 kg.",
  ...
  pitfall: {
    ...
    correction:
      "In a vacuum, all objects fall at the same rate regardless of mass. Air resistance, not mass, causes differences in everyday experience.",
    example:
      "A hammer and a feather dropped on the Moon (no air) hit the ground at the same time — Apollo 15 demonstrated this.",
    ...
    problems: [
      {
        difficulty: "warm",
        question:
          "A 2 kg toy car is pushed with a net force of 6 N on a frictionless surface. What is its acceleration?",
        hints: [
          { level: 1, text: "Write down F = ma and identify what you know." },
          {
            level: 2,
            text: "You know F = 6 N and m = 2 kg. Solve for a."
          }
        ],
        solution: {
      ...
      },
      {
        difficulty: "medium",
        question:
          "A 1500 kg car accelerates from rest to 20 m/s in 10 seconds. What net force is required?",
        hints: [
          {
            level: 1,
            text: "First find acceleration: a = Δv / Δt."
          },
          {
            level: 2,
            text: "a = (20 − 0) / 10 = 2 m/s². Now use F = ma."
          }
        ],
        solution: {
          approach:
            "Find acceleration from velocity change, then apply F = ma.",
      ...
      },
      {
        difficulty: "cold",
        question:
          "Two blocks (3 kg and 7 kg) are connected by a string on a frictionless surface. A 50 N force pulls the 7 kg block. Find the acceleration and the tension in the string.",
        hints: [
          {
            level: 1,
            text: "Treat both blocks as one system to find acceleration."
          },
          {
            level: 2,
            text: "Total mass = 10 kg. a = 50/10 = 5 m/s²."
          },
          {
            level: 3,
            text: "For the 3 kg block alone: T = 3 × 5 = 15 N."
          }
        ],
        solution: {
          approach:
            "System approach for acceleration, isolate one block for tension.",
  ...
  what_next: {
    ...
    preview:
      "Every force has an equal and opposite partner — but they act on different objects."
  }
};

export const interactiveLabPreview: TemplatePreview = {
  section: labPhysicsSection,
  summary:
    "A physics section where the simulation sits front and centre — learners manipulate force and mass sliders before reading the formal F = ma explanation."
};
