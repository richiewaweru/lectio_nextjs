...
export const timelineNarrativePreview: TemplatePreview = {
  section: {
    ...
    header: {
      ...
      objective: "Trace how observations and experiments shifted medicine toward germ theory."
    },
    hook: {
    ...
    practice: {
      problems: [
        ...
        },
        {
          ...
          hints: [{ level: 1, text: "Compare general contamination evidence with disease-specific causation." }],
          solution: {
  ...
  summary:
    "A history-style lesson that uses a timeline spine to show why acceptance of germ theory unfolded over decades."
};
