...
export const distinctionGridPreview: TemplatePreview = {
  section: {
    section_id: "civics-distinction-01",
    template_id: "distinction-grid",
    header: {
      ...
      objective: "Distinguish how three government systems distribute power between national and regional levels."
    },
    hook: {
    ...
    insight_strip: {
      cells: [
        ...
        { label: "Federal", value: "Power shared", note: "Balanced structure", highlight: true },
    ...
    comparison_grid: {
      ...
      rows: [
        ...
        {
          criterion: "Best clue",
          values: ["One clear center", "Constitutional sharing", "Alliance of strong states"]
        }
      ],
  ...
  summary:
    "A civics classification lesson that uses a three-way comparison grid to keep the categories separate."
};
