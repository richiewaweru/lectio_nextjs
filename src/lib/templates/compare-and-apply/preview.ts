...
export const compareAndApplyPreview: TemplatePreview = {
  section: {
    ...
    header: {
      ...
      objective: "Distinguish saturated and unsaturated hydrocarbons and apply the difference to reactivity."
    },
    hook: {
    ...
    insight_strip: {
      cells: [
        ...
        { label: "Alkenes", value: "At least one double bond", note: "More reactive", highlight: true }
      ]
    },
    comparison_grid: {
    ...
    pitfall: {
      ...
      correction:
        "The double bond changes the reaction options available, so the family classification matters.",
  ...
  summary:
    "A chemistry contrast lesson that makes the structural comparison do the heavy lifting before practice."
};
