...
export const diagramLedLessonPreview: TemplatePreview = {
  section: {
    section_id: "bio-diagram-led-01",
    template_id: "diagram-led-lesson",
    header: {
      ...
      objective: "Track how one cell moves through visible mitosis stages before division."
    },
    hook: {
    ...
    glossary: {
      terms: [
        { term: "Mitosis", definition: "The process that produces two genetically similar cells." },
        { term: "Metaphase", definition: "The stage where chromosomes align in the middle." }
      ]
    },
    practice: {
      problems: [
  ...
  summary:
    "A biology lesson where a staged diagram sequence carries the core meaning of the page."
};
